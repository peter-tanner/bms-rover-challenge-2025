...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  if(htim->Instance==TIM2)
  {
    ...
    PA0     ------> TIM2_CH1
    */
    GPIO_InitStruct.Pin = TIM2_CH1__BUZZ_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM2;
    HAL_GPIO_Init(TIM2_CH1__BUZZ_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  else if(htim_base->Instance==TIM16)
  {
    ...
    /* USER CODE BEGIN TIM16:TIM16_FDCAN_IT0_IRQn disable */
    /**
    * Uncomment the line below to disable the "TIM16_FDCAN_IT0_IRQn" interrupt
    * Be aware, disabling shared interrupt may affect other IPs
    */
    /* HAL_NVIC_DisableIRQ(TIM16_FDCAN_IT0_IRQn); */
    /* USER CODE END TIM16:TIM16_FDCAN_IT0_IRQn disable */
